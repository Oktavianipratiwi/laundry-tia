...
<head>
    ...
    <title>Tia Laundry - Kurir Sedang Menuju Lokasi untuk Pengantaran Pakaian</title>
</head>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>Kami ingin memberitahu bahwa kurir kami sedang dalam perjalanan menuju lokasi Anda untuk pengantaran pakaian. Mohon untuk tetap berada di lokasi pengambilan.</p>
